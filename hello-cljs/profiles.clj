;;; ****************************** NOTES ******************************
;;;
;;; The hello-cljs/profiles.clj file is used for keeping the developer
...
;;; view of the lib.  The hello-cljs/profiles.clj should never contain
;;; any configuration for the :user profile. The content of
;;; hello-cljs/profiles.clj will be merge with the content from the
;;; ~/.lein/profiles.clj and hello-cljs/project.clj. Keep in mind that
;;; any in case of conflicts, the hello-cljs/profiles.clj takes
;;; precedence over the hello-cljs/project.clj which, in turn, takes
       ...
       {;; Here we configure one build for each compiler optmizations
        ...
        :builds {;; The :whitespace optimizations build. This is the
                 ...
                 {:source-paths ["src/cljs" "test/cljs" "dev-resources/tools/repl"]
                  :compiler
                  {:output-to "dev-resources/public/js/hello-cljs.js"
                   :output-dir "dev-resources/public/js"
                   :source-map "dev-resources/public/js/hello-cljs.js.map"
        ...
        :test-commands {;; test :whitespace build against phantomjs
                        "phantomjs-ws"
                        ["phantomjs" :runner "dev-resources/public/js/hello-cljs.js"]
